...
public class Client {
    ...
    public static String IP = "http://18.117.216.20:8080";
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        String output = String.format("NumThreads = %d, numSkiers = %d, numLifts = %d", client.numThreads, client.numSkiers, client.numLifts);
